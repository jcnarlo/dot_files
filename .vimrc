...
"jcnii let calendar_diary = "~/vimfiles/diary"
let calendar_diary = "~/.vim/diary"
...
nnoremap <Leader>d k/^#if.*jcnii<C-CR>0%%mn%V%d'ndd
" Remove bottom of if else
nnoremap <Leader><Leader>d k/^#if.*jcnii<C-CR>0mn%V%d'ndd
...
nnoremap <Leader><Leader>a k/^#{\s*jcnii<CR><C-v>l%hkI#<Esc>x
"Un-Comment out top section
nnoremap <Leader><Leader>A k/^#{\s*jcnii<CR><C-v>l%hkxI#<Esc>
"Comment out bottom section
nnoremap <Leader><Leader>b k/^#{\s*jcnii<CR>l%h<C-v>ll%hkI#<Esc>xN
"Un-Comment out bottom section
nnoremap <Leader><Leader>B k/^#{\s*jcnii<CR>l%h<C-v>ll%hkxI#<Esc>N
...
"let Grep_Path = '/mnt/d/Share/Users/jcnarlo/local/bin/GetGnuWin32/gnuwin32/bin/grep.exe'
"let Egrep_Path = '/mnt/d/Share/Users/jcnarlo/local/bin/GetGnuWin32/gnuwin32/bin/egrep.exe'
"let Fgrep_Path = '/mnt/d/Share/Users/jcnarlo/local/bin/GetGnuWin32/gnuwin32/bin/Fgrep.exe'
"let Grep_Find_Path = '/mnt/d/Share/Users/jcnarlo/local/bin/GetGnuWin32/gnuwin32/bin/find.exe'
"let Grep_Xargs_Path = '/mnt/d/Share/Users/jcnarlo/local/bin/GetGnuWin32/gnuwin32/bin/xargs.exe'

let Grep_Default_Filelist = '.'
let Grep_Default_Filelist = 'src include'
let Grep_Default_Options = '-R'
let Grep_Cygwin_Find = 0
let Grep_Skip_Dirs = 'tmp .svn .git share x64 bin build builds __pycache__ _Archive _archive data doc'
